%% Train_MLP
clc;
file = readtable('./MLP/csv/MLP_train_60.csv'); %%change name
...
fprintf(1,'\nr2   = %6.4f',r2);
%% Validation_MLP
file = readtable('./MLP/csv/MLP_val_60.csv'); %%change name
file.Properties.VariableNames;
true = reshape(file.Cm_pF,[],1);
predict = reshape(file.Cm_pred_pF,[],1);
mse = mean((true - predict).^2);
...
fprintf(1,'\nr2   = %6.4f',r2);
%% Test_MLP
file = readtable('./MLP/csv/MLP_test_60.csv'); %%change name
file.Properties.VariableNames;

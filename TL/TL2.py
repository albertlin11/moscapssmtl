...
base_layer2 = base_model.get_layer(index=2)
base_layer.trainable = False
base_layer2.trainable = False

x = tf.keras.Input(shape=(6,))
x1=base_layer(x)
x2=base_layer2(x1)
#x2=tf.keras.layers.Dense(units = 10, activation='relu',name='dense_2')(x1)
y1=tf.keras.layers.Dense(units =  1,name='dense_3')(x2)
